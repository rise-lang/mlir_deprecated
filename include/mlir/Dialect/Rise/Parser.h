...
// =============================================================================
//
// This file implements the parser for the Rise language. It processes the Token
// provided by the Lexer and returns an AST.
//
//===----------------------------------------------------------------------===//

#ifndef MLIR_TUTORIAL_RISE_PARSER_H
#define MLIR_TUTORIAL_RISE_PARSER_H
...
/// This is a simple recursive parser for the Rise language. It produces a well
  ...
  std::unique_ptr<VarType> ParseToyArrayType() {
    ...
    std::unique_ptr<VarType> ParseExplicitTypeDef() {
        ...
        if (lexer.getCurToken() == tok_identifier) {
            llvm::errs() << "Rise Type: " << lexer.getCurToken();
            type->elt_ty=VarType::TY_RISE;
        }
...
#endif // MLIR_TUTORIAL_RISE_PARSER_H
