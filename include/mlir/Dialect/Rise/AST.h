//===- AST.h - Node definition for the Rise AST ----------------------------===//
//
...
// =============================================================================
//
// This file implements the AST for the Rise language. It is optimized for
// simplicity, not efficiency. The AST forms a tree structure where each node
// references its children using std::unique_ptr<>.
//
//===----------------------------------------------------------------------===//

#ifndef MLIR_TUTORIAL_RISE_AST_H_
#define MLIR_TUTORIAL_RISE_AST_H_
...
/// A variable
struct VarType {
  enum { TY_FLOAT, TY_INT, TY_RISE } elt_ty;
...
#endif // MLIR_TUTORIAL_RISE_AST_H_
